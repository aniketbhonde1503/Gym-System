     ...
     <div class="widget-content">
            <div class="row-fluid">
              <div class="span4">
                <table class="">
                  <tbody>
                    <tr>
                      <td><h4>ADPS Fitness Club</h4></td>
                    </tr>
                    <tr>
                      <td> ADPS Fitness Club, Yavatmal 445001</td>
                    </tr>
                    
                    <tr>
                      <td>Tel: 9763168031</td>
                    </tr>
                    <tr>
                      <td >Email: adpsfitnessclub@gmail.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table table-bordered table-invoice-full">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><div class="text-center"><?php if($row['plan'] == 0) { echo 'NONE';} else {echo $row['plan'].' Month';} ?></div></td>
            ...
            <div class="row-fluid">
                ...
                <div class="pull-right">
                  ...
                  <img src="../img/report/stamp-sample.png" width="124px;" alt=""><p class="text-center">ADPS Fitness Club </p> </div>
