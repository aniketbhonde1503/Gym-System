...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="attendance.php" class="current">Plans</a> </div>
    <h1 class="text-center">Plan List <i class="fas fa-tasks"></i></h1>
  </div>
