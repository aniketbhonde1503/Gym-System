        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
              <input type="text" id="mask-phone" name="contact" placeholder="9876543210" class="span8 mask text" maxllength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);">
                <span class="help-block blue span8">No need to Add Country code</span> 
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  ...
                  Fitness <small>- Rs 1000 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services" />
                  Sauna <small>- Rs 500 per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services" />
                  Cardio <small>- Rs 700 per month</small></label>
              </div>
            </div>
